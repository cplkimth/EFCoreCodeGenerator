...
/*
This file has been generated by UsingEntityFrameworkCore on 2022-07-21 오전 1:06:33.
...
public partial class Code : Entity<Code>, IEntity
{
	...
	public static void Copy(Code source, Code target)
	{
		...
		target.CodeCategory = source.CodeCategory;		
		target.Name = source.Name;
	}
	...
	public override string ToString()
	{
		...
		return "[CodeId]" + CodeId + ", " + "[CodeCategory]" + CodeCategory + ", " + "[Name]" + Name;
	}
...
public partial class CodeCategory : Entity<CodeCategory>, IEntity
{
	...
	{
				target.CodeCategory1 = source.CodeCategory1;		
		target.Name = source.Name;
	}
	...
	public override string ToString()
	{
		...
		return "[CodeCategory1]" + CodeCategory1 + ", " + "[Name]" + Name;
	}
	...
	public override string PrimaryKeyValues
	{
		get { return string.Join(":", CodeCategory1); }
	}
...
public class CodeCategoryEqualityComparer : IEqualityComparer<CodeCategory>
{
	...
	{
		return x.CodeCategory1 == y.CodeCategory1;
	}

	public int GetHashCode(CodeCategory obj)
	{
		return obj.CodeCategory1.GetHashCode();
	}
}
...
public partial class Customer : Entity<Customer>, IEntity
{
	...
	public override string ToString()
	{
		...
		return "[CustomerId]" + CustomerId + ", " + "[Email]" + Email + ", " + "[EmployeeId]" + EmployeeId + ", " + "[FirstName]" + FirstName + ", " + "[LastName]" + LastName;
	}
...
public partial class Employee : Entity<Employee>, IEntity
{
	...
	public override string ToString()
	{
		...
		return "[EmployeeId]" + EmployeeId + ", " + "[BossId]" + BossId + ", " + "[Email]" + Email + ", " + "[FirstName]" + FirstName + ", " + "[HiredOn]" + HiredOn + ", " + "[LastName]" + LastName + ", " + "[Phone]" + Phone + ", " + "[Title]" + Title;
	}
...
public partial class Invoice : Entity<Invoice>, IEntity
{
	...
	public static void Copy(Invoice source, Invoice target)
	{
		...
		target.CustomerId = source.CustomerId;		
		target.OrderedAt = source.OrderedAt;		
	...
	public override string ToString()
	{
		...
		return "[InvoiceId]" + InvoiceId + ", " + "[CustomerId]" + CustomerId + ", " + "[OrderedAt]" + OrderedAt + ", " + "[Total]" + Total;
	}
...
public partial class Track : Entity<Track>, IEntity
{
	...
	public static void Copy(Track source, Track target)
	{
		...
		target.GenreCode = source.GenreCode;		
		target.MediaTypeCode = source.MediaTypeCode;		
	...
	public override string ToString()
	{
		...
		return "[TrackId]" + TrackId + ", " + "[AlbumId]" + AlbumId + ", " + "[Bytes]" + Bytes + ", " + "[Composer]" + Composer + ", " + "[GenreCode]" + GenreCode + ", " + "[MediaTypeCode]" + MediaTypeCode + ", " + "[Milliseconds]" + Milliseconds + ", " + "[Name]" + Name + ", " + "[UnitPrice]" + UnitPrice;
	}
...
public partial class CodeDao : EntityDao<Code>
{
    ...
    public virtual Task<Code> GetByKeyAsync(int codeId)
		=> Task.Factory.StartNew(() => GetByKey(codeId));
	...
	=> Task.Factory.StartNew(() => ExistsByKey(codeId));
	...
	=> Task.Factory.StartNew(() => DeleteByKey(codeId));
    ...
    /// <param name="entity">삽입할 엔터티</param>
	/// <returns>삽입된 엔터티</returns>
    public virtual Code InsertIfNotExist(Code entity)
	{
        using var context = DbContextFactory.Create();
    ...
    public virtual Task<Code> InsertIfNotExistAsync(Code entity)
	=> Task.Factory.StartNew(() => InsertIfNotExist(entity));
    ...
    /// <param name="entity">삽입 혹은 갱신할 엔터티</param>
	/// <returns>삽입 혹은 갱신된 엔터티</returns>
    public virtual Code InsertOrUpdate(Code entity)
	{
        using var context = DbContextFactory.Create();
    ...
    public virtual Task<Code> InsertOrUpdateAsync(Code entity)
	=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
	

		/// <summary>
	/// 외래키 CodeCategory 이(가) 일치하는 엔터티 컬렉션을 구한다.
	/// </summary>
	/// <param name="codeCategory">외래키</param>
	/// <returns>CodeCategory 이(가) 일치하는 엔터티 컬렉션</returns>
    public virtual List<Code> GetByCodeCategory(int codeCategory)
	{
        using var context = DbContextFactory.Create();

		return context.Set<Code>().Where(x => x.CodeCategory == codeCategory).ToList();
	}

    public virtual Task<List<Code>> GetByCodeCategoryAsync(int codeCategory)
	=> Task.Factory.StartNew(() => GetByCodeCategory(codeCategory));
}
#endregion
...
public partial class CodeCategoryDao : EntityDao<CodeCategory>
{
	...
	/// 기본키가 일치하는 엔터티를 구한다.
	/// </summary>
		/// <param name="codeCategory1">기본키</param>
	/// <returns>기본키가 일치하는 엔터티</returns>
    public virtual CodeCategory GetByKey(int codeCategory1)
	{
        using var context = DbContextFactory.Create();

        return context.Set<CodeCategory>().FirstOrDefault(x =>  x.CodeCategory1 == codeCategory1);
	}

    public virtual Task<CodeCategory> GetByKeyAsync(int codeCategory1)
		=> Task.Factory.StartNew(() => GetByKey(codeCategory1));
	...
	/// </summary>
		/// <param name="codeCategory1">기본키</param>
	/// <returns>존재 여부</returns>
    public virtual bool ExistsByKey(int codeCategory1)
	{
        using var context = DbContextFactory.Create();

		return context.Set<CodeCategory>().Count(x =>  x.CodeCategory1 == codeCategory1) > 0;
	}

    public virtual Task<bool> ExistsByKeyAsync(int codeCategory1)
	=> Task.Factory.StartNew(() => ExistsByKey(codeCategory1));
	...
	/// </summary>
		/// <param name="codeCategory1">기본키</param>
	/// <returns>삭제된 엔터티의 갯수</returns>
    public virtual int DeleteByKey(int codeCategory1)
	{
        using var context = DbContextFactory.Create();

		var query = from x in context.Set<CodeCategory>()
		where x.CodeCategory1 == codeCategory1
		select x;
    ...
    public virtual Task<int> DeleteByKeyAsync(int codeCategory1)
	=> Task.Factory.StartNew(() => DeleteByKey(codeCategory1));
    ...
    /// <param name="entity">삽입할 엔터티</param>
	/// <returns>삽입된 엔터티</returns>
    public virtual CodeCategory InsertIfNotExist(CodeCategory entity)
	{
        using var context = DbContextFactory.Create();

	    if (context.Set<CodeCategory>().Count(x =>  x.CodeCategory1 == entity.CodeCategory1) > 0)
	        return null;
    ...
    public virtual Task<CodeCategory> InsertIfNotExistAsync(CodeCategory entity)
	=> Task.Factory.StartNew(() => InsertIfNotExist(entity));
    ...
    /// <param name="entity">삽입 혹은 갱신할 엔터티</param>
	/// <returns>삽입 혹은 갱신된 엔터티</returns>
    public virtual CodeCategory InsertOrUpdate(CodeCategory entity)
	{
        using var context = DbContextFactory.Create();
    ...
    public virtual Task<CodeCategory> InsertOrUpdateAsync(CodeCategory entity)
	=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
...
public partial class CustomerDao : EntityDao<Customer>
{
	...
	=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
		...
		/// <summary>
	/// 외래키 EmployeeId 이(가) 일치하는 엔터티 컬렉션을 구한다.
	/// </summary>
	/// <param name="employeeId">외래키</param>
	/// <returns>EmployeeId 이(가) 일치하는 엔터티 컬렉션</returns>
    public virtual List<Customer> GetByEmployeeId(int? employeeId)
	{
        using var context = DbContextFactory.Create();

		return context.Set<Customer>().Where(x => x.EmployeeId == employeeId).ToList();
	}

    public virtual Task<List<Customer>> GetByEmployeeIdAsync(int? employeeId)
	=> Task.Factory.StartNew(() => GetByEmployeeId(employeeId));
}
#endregion
#region EmployeeDao
/// <summary>
...
public partial class EmployeeDao : EntityDao<Employee>
{
	...
	=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
		...
		/// <summary>
	/// 외래키 BossId 이(가) 일치하는 엔터티 컬렉션을 구한다.
	/// </summary>
	/// <param name="bossId">외래키</param>
	/// <returns>BossId 이(가) 일치하는 엔터티 컬렉션</returns>
    public virtual List<Employee> GetByBossId(int? bossId)
	{
        using var context = DbContextFactory.Create();

		return context.Set<Employee>().Where(x => x.BossId == bossId).ToList();
	}

    public virtual Task<List<Employee>> GetByBossIdAsync(int? bossId)
	=> Task.Factory.StartNew(() => GetByBossId(bossId));
}
#endregion
#region InvoiceDao
/// <summary>
