...
/*
1 This file has been generated by UsingEntityFrameworkCore on 2023-09-18 오후 4:52:43.
...
public partial class `Name`Dao : EntityDao<`Name`>
{
	...
	/// </summary>
	`P::
	/// <param name="`CamelName`">기본키</param>
	``
	/// <returns>삭제된 엔터티의 갯수</returns>
	...
	*/
    ...
    public virtual List<`Name`> GetBy`Name`(`Type` `CamelName`)
	{
        using var context = DbContextFactory.Create();

		return context.Set<`Name`>().Where(x => x.`Name` == `CamelName`).ToList();
	}

    public virtual Task<List<`Name`>> GetBy`Name`Async(`Type` `CamelName`)
