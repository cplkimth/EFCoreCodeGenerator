...
/*
This file has been generated by UsingEntityFrameworkCore on 2022-07-25 오전 12:31:36.
...
namespace Chinook.Data
{
	...
	public partial class ArtistDao : EntityDao<Artist>
	{
		...
		=> Task.Factory.StartNew(() => GetByCompanyId(companyId));
	}
	#endregion
	#region CompanyDao
	/// <summary>
	...
	public partial class CompanyDao : EntityDao<Company>
	{
        ...
        public virtual Task<Company> GetByKeyAsync(int companyId)
			=> Task.Factory.StartNew(() => GetByKey(companyId));
		...
		=> Task.Factory.StartNew(() => ExistsByKey(companyId));
		...
		=> Task.Factory.StartNew(() => DeleteByKey(companyId));
        ...
        /// <param name="entity">삽입 혹은 갱신할 엔터티</param>
		/// <returns>삽입 혹은 갱신된 엔터티</returns>
        public virtual Company InsertOrUpdate(Company entity)
	    {
            using var context = DbContextFactory.Create();
        ...
        public virtual Task<Company> InsertOrUpdateAsync(Company entity)
		=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
	...
	public partial class PlaylistTrackHistoryDao : EntityDao<PlaylistTrackHistory>
	{
        ...
        public virtual Task<PlaylistTrackHistory> GetByKeyAsync(int playlistId, int trackId, DateTime writtenAt)
			=> Task.Factory.StartNew(() => GetByKey(playlistId, trackId, writtenAt));
		...
		=> Task.Factory.StartNew(() => ExistsByKey(playlistId, trackId, writtenAt));
		...
		=> Task.Factory.StartNew(() => DeleteByKey(playlistId, trackId, writtenAt));
        ...
        /// <param name="entity">삽입 혹은 갱신할 엔터티</param>
		/// <returns>삽입 혹은 갱신된 엔터티</returns>
        public virtual PlaylistTrackHistory InsertOrUpdate(PlaylistTrackHistory entity)
	    {
            using var context = DbContextFactory.Create();
        ...
        public virtual Task<PlaylistTrackHistory> InsertOrUpdateAsync(PlaylistTrackHistory entity)
		=> Task.Factory.StartNew(() => InsertOrUpdate(entity));
